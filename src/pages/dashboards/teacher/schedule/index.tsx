...
import { getTeacherLessonsWeek } from '../../../../shared/api';
import type { LessonForScheduleDto } from '../../../../shared/api';
import { ScheduleGrid, SchedulePageContent, TeacherLessonModal } from '../../../../shared/ui';
...
export function SchedulePage() {
  ...
  const {
    ...
    storageKey: 'teacher-schedule-anchor-date',
    fetchLessons: getTeacherLessonsWeek,
